      ...
      <aside className="w-64 bg-white dark:bg-gray-900 shadow-md hidden sm:block">
        ...
        <nav className="mt-6 space-y-2">
          {[
            ...
            { label: 'Manage Users', key: 'users', icon: '👥' },
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                ...
                className="w-10 h-10 rounded-full overflow-hidden border-2 border-blue-600 dark:border-blue-400"
              >
                <img
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded shadow-lg py-2 z-50">
                  <button
                    ...
                    className="block w-full text-left px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-blue-100 dark:hover:bg-blue-950"
                  >
                    Profile
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-red-600 hover:bg-red-100 dark:hover:bg-red-800"
                  >
                    Logout
                  </button>
                </div>
